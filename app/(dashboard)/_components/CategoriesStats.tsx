"use client"
import { GetCategoryStatsType } from '@/app/api/stats/categories/route'
...
function CategoriesCard({data, type, formatter} : {type : TransactionType, formatter : Intl.NumberFormat, data : GetCategoryStatsType}) {
