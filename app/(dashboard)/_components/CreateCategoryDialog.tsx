...
function CreateCategoryDialog({type, successCallback} : {type : TransactionType, successCallback : (category : Category) => void}) {
                        ...
                        <FormField 
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    ...
                                    <FormControl>
                                        <Input required placeholder='Category' {...field} />
                                    </FormControl>
                        ...
                        <FormField 
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    ...
                                    <FormDescription>This is how your category will look like</FormDescription>
                                </FormItem>
                            )}
                        />
                    </form>
